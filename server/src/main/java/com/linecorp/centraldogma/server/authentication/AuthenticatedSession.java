...
/**
 * An authenticated session which can be replicated to the other Central Dogma replica as a serialized form.
 */
public final class AuthenticatedSession implements Serializable {
    ...
    public AuthenticatedSession(@JsonProperty("id") String id,
        ...
        this.rawSession = firstNonNull(rawSession, this);
    }
    ...
    <T> T castedRawSession() {
        return Util.unsafeCast(rawSession);
    }
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                          ...
                          .add("rawSession", rawSession.getClass().getSimpleName())
                          .toString();
    }
}
